...
Shader "CBG/Dissolve/Mobile/MobileDissolveSpecular" 
{
  ...
  SubShader 
  {
    ...
    CGPROGRAM
    #pragma surface surf SimpleSpecular alphatest:Zero exclude_path:prepass nolightmap noforwardadd halfasview noambient
